...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://test.api.yadrocrm.ru/tmp';
     ...
     * @var string
     */
    protected $userAgent = "IntrovertApiClient/0.0.3/php";
    ...
    public function __construct()
    {
        ...
        $this->addDefaultHeader('X-Script', $_SERVER['SCRIPT_FILENAME']);
    }
    ...
    {
        $report  = 'PHP SDK (Introvert) Debug Report:' . PHP_EOL;
