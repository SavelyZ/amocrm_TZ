...
class MailApi
{
    ...
    public function getTemplateWithHttpInfo($id)
    {
        ...
        // parse inputs
        $resourcePath = "/mail/getTemplates";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    {
        list($response) = $this->getTemplatesListWithHttpInfo();
        return $response;
    }

    /**
     * Operation getTemplatesListWithHttpInfo
     *
     * Возвращает список шаблонов писем
     *
     * @throws \Introvert\ApiException on non-2xx response
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTemplatesListWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/mail/getTemplatesList";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
     ...
     * Отправляет письмо
     *
     * @param \Introvert\Model\Mail | array $body Объект отправляемого письма (required)
     * @throws \Introvert\ApiException on non-2xx response
     * @return object | array
     */
